<?php
	...
	if( !class_exists('Wbcr_FactoryForms428_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms428_Bootstrap3FormLayout extends Wbcr_FactoryForms428_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms428_Control $control
			 */
