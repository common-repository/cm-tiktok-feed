<?php
	...
	if( !class_exists('Wbcr_FactoryForms428_Control') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms428_Control extends Wbcr_FactoryForms428_FormElement {
			 ...
			 *
			 * @param mixed[] $options
			 * @param FactoryForms428_Form $form
			 * @param null $provider
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @since 1.0.0
			 * @param IFactoryForms428_ValueProvider $provider
			 * @return void
			 */
