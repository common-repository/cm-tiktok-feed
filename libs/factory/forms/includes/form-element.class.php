<?php
	...
	if( !class_exists('Wbcr_FactoryForms428_FormElement') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms428_FormElement {
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_FactoryForms428_HtmlAttributeBuilder
			 */
			 ...
			 * @param Wbcr_FactoryForms428_Form $form A parent form.
			 */
			public function __construct($options, $form)
			{
				...
				$this->html_builder = new Wbcr_FactoryForms428_HtmlAttributeBuilder();
