<?php
	...
	if( !class_exists('Wbcr_FactoryForms428_FormLayout') ) {

		/**
		 * The base class for all form layouts.
		 */
		abstract class Wbcr_FactoryForms428_FormLayout extends Wbcr_FactoryForms428_Holder {
			...
			public function __construct($options, $form)
			{
				...
				$this->addCssClass('factory-forms-428-' . $this->type);
				$this->addCssClass('factory-forms-428-' . $this->name);
			}
