<?php
	...
	if( !class_exists('Wbcr_FactoryForms428_ControlHolder') ) {
		/**
		 * The base class for control holders.
		 *
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms428_ControlHolder extends Wbcr_FactoryForms428_Control {
			 ...
			 *
			 * @since 1.0.0
			 * @return Wbcr_FactoryForms428_FormElement[].
			 */
