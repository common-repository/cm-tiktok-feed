<?php
	...
	if( !class_exists('Wbcr_FactoryForms428_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms428_OptionsValueProvider implements Wbcr_IFactoryForms428_ValueProvider {
