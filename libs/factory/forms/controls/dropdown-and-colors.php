<?php
	 ...
	 *  // see FactoryForms428_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms428_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms428_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms428_DropdownAndColorsControl extends Wbcr_FactoryForms428_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms428_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms428_RadioColorsControl($options['colors'], $form, $provider);
