<?php
	...
	if( !class_exists('Wbcr_FactoryForms428_PaddingsEditorControl') ) {

		class Wbcr_FactoryForms428_PaddingsEditorControl extends Wbcr_FactoryForms428_Control {
				...
				<div <?php $this->attrs() ?>
					...
					<div class="factory-slider-container">
						<label class="factory-title">
							<?php _e('Select a side and move the slider to set up:', 'wbcr_factory_forms_428') ?>
						</label>
