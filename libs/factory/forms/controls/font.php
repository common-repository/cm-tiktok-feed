<?php
	...
	if( !class_exists('Wbcr_FactoryForms428_FontControl') ) {

		class Wbcr_FactoryForms428_FontControl extends Wbcr_FactoryForms428_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->size = new Wbcr_FactoryForms428_IntegerControl($option_font_size, $form, $provider);
				$this->family = new Wbcr_FactoryForms428_DropdownControl($option_font_family, $form, $provider);
				$this->color = new Wbcr_FactoryForms428_ColorControl($optionFontColor, $form, $provider);
			...
			public function getFonts()
			{
				...
				$fonts = apply_filters('wbcr_factory_forms_428_fonts', $fonts);
				$fonts = apply_filters('wbcr_factory_forms_428_fonts-' . $this->options['name'], $fonts);
			...
			public function getDefaultFonts()
			{
				...
				$fonts = array(
					...
					array('inherit', __('(use default website font)', 'wbcr_factory_forms_428')),
					array(
						'group',
						__('Sans Serif:', 'wbcr_factory_forms_428'),
						array(
					...
					array(
						'group',
						__('Serif:', 'wbcr_factory_forms_428'),
						array(
							array(
					...
					array(
						'group',
						__('Monospaced:', 'wbcr_factory_forms_428'),
						array(
