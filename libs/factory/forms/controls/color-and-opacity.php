<?php
	...
	if( !class_exists('Wbcr_FactoryForms428_ColorAndOpacityControl') ) {
	}

	class Wbcr_FactoryForms428_ColorAndOpacityControl extends Wbcr_FactoryForms428_ComplexControl {
		...
		public function __construct($options, $form, $provider = null)
		{
			...
			$this->opacity = new Wbcr_FactoryForms428_IntegerControl($options['opacity'], $form, $provider);
