<?php
	...
	if( !class_exists('Wbcr_FactoryForms428_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms428_TabHolder extends Wbcr_FactoryForms428_Holder {
			 ...
			 * @param FactoryForms428_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms428_HtmlAttributeBuilder();
