<?php
	...
	if( !class_exists('Wbcr_FactoryForms428_GradientControl') ) {
		class Wbcr_FactoryForms428_GradientControl extends Wbcr_FactoryForms428_Control {
			...
			public function html()
			{
				...
				<script>
					...
					factory.res.resVertical = '<?php _e( 'vertical', 'wbcr_factory_forms_428' ) ?>';
					factory.res.resHorizontal = '<?php _e( 'horizontal', 'wbcr_factory_forms_428' ) ?>';
				</script>
				<div <?php $this->attrs() ?>>
