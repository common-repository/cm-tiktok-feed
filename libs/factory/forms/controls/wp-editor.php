<?php
	...
	if( !class_exists('Wbcr_FactoryForms428_WpEditorControl') ) {

		class Wbcr_FactoryForms428_WpEditorControl extends Wbcr_FactoryForms428_Control {
			...
			protected function beforeHtml()
			{
				...
				if( !isset($this->options['tinymce']['content_css']) ) {
					$this->options['tinymce']['content_css'] = FACTORY_FORMS_428_URL . '/assets/css/editor.css';
				}
			}
