<?php
	...
	if( !class_exists('Wbcr_FactoryForms428_DatepickerRangeControl') ) {

		class Wbcr_FactoryForms428_DatepickerRangeControl extends Wbcr_FactoryForms428_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->range_1 = new Wbcr_FactoryForms428_TextboxControl($options['range_1'], $form, $provider);
				$this->range_2 = new Wbcr_FactoryForms428_TextboxControl($options['range_2'], $form, $provider);
