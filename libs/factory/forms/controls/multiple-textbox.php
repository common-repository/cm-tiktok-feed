<?php
	...
	if( !class_exists('Wbcr_FactoryForms428_MultipleTextboxControl') ) {

		class Wbcr_FactoryForms428_MultipleTextboxControl extends Wbcr_FactoryForms428_Control {
			...
			public function html()
			{
				...
				<div class="factory-multiple-textbox-group">
					...
					<button class="btn btn-default btn-small factory-mtextbox-add-item">
						<i class="fa fa-plus" aria-hidden="true"></i> <?php _e('Add new', 'wbcr_factory_forms_428') ?>
					</button>
				</div>
