...
if ( ! class_exists( 'Wbcr_FactoryPages430_Page' ) ) {

	class Wbcr_FactoryPages430_Page {
		...
		public function executeByName( $action ) {
			...
			if ( ! method_exists( $this, $actionFunction ) ) {
				...
				/*$custom_actions = apply_filters('wbcr/factory_pages_430/custom_actions', array(), $raw_action_name);
