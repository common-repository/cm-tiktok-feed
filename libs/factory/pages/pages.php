<?php
	...
	add_action('admin_menu', 'Wbcr_FactoryPages430::actionAdminMenu');
	add_action('network_admin_menu', 'Wbcr_FactoryPages430::actionAdminMenu');
	...
	if( !class_exists('Wbcr_FactoryPages430') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryPages430 {

			/**
			 * @var Wbcr_FactoryPages430_Page[]
			 */
			...
			public static function getPageUrl(Wbcr_Factory430_Plugin $plugin, $page_id, $args = array())
			{
				if( isset(self::$pages[$plugin->getPluginName()]) ) {
	...
	if( !function_exists('wbcr_factory_pages_430_get_page_id') ) {
		/**
		 *
		 * @param Wbcr_Factory430_Plugin $plugin
		 ...
		 * @return string
		 */
		function wbcr_factory_pages_430_get_page_id($plugin, $page_id)
		{
