...
namespace WBCR\Factory_Freemius_118\Premium;

use WBCR\Factory_Freemius_118\Entities\License;
use WBCR\Factory_Freemius_118\Entities\Plugin;
use WBCR\Factory_Freemius_118\Entities\Site;
use WBCR\Factory_Freemius_118\Entities\User;
use WBCR\Factory_430\Premium\Provider as License_Provider;
use Wbcr_Factory430_Plugin;
use WBCR\Factory_Freemius_118\Api;
use WP_Error;
use Exception;
...
final class Provider extends License_Provider {
	...
	/**
	 * @var \WBCR\Factory_Freemius_118\Api
	 */
	private $site_api;
	 ...
	 * @throws Exception
	 */
	public function __construct(Wbcr_Factory430_Plugin $plugin, array $settings)
	{
	...
	/**
	 * @return \WBCR\Factory_Freemius_118\Entities\License|null
	 * @throws Exception
	 */
	 ...
	 * @param bool $flush
	 *
	 * @return \WBCR\Factory_Freemius_118\Api
	 * @throws Exception
	 */
