...
namespace WBCR\Factory_Freemius_118\Updates;

// Exit if accessed directly
use Exception;
use Wbcr_Factory430_Plugin;
use WBCR\Factory_430\Updates\Repository;
...
class Freemius_Repository extends Repository {
	...
	/**
	 * @var \WBCR\Factory_Freemius_118\Premium\Provider
	 */
	private $premium;
	...
	public function init() {
		if ( ! $this->premium instanceof \WBCR\Factory_Freemius_118\Premium\Provider ) {
