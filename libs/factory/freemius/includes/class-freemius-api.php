...
namespace WBCR\Factory_Freemius_118;
...
final class Api {
	...
	/**
	 * @param Wbcr_Factory430_Plugin $slug
	 ...
	 */
	private function __construct( Wbcr_Factory430_Plugin $plugin, $scope, $id, $public_key, $secret_key, $is_sandbox ) {
	 ...
	 * @return Api
	 */
	public static function instance( Wbcr_Factory430_Plugin $plugin, $scope, $id, $public_key, $is_sandbox, $secret_key = false ) {
