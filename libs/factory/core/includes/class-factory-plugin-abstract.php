 ...
 *
 */
abstract class Wbcr_Factory430_Plugin extends Wbcr_Factory430_Base {

	/**
	 * Instance class Wbcr_Factory430_Request, required manages http requests
	 *
	 * @see https://webcraftic.atlassian.net/wiki/spaces/FFD/pages/390561806
	 * @var Wbcr_Factory430_Request
	 */
	public $request;

	/**
	 * @see https://webcraftic.atlassian.net/wiki/spaces/FFD/pages/393936924
	 * @var \WBCR\Factory_430\Premium\Provider
	 */
	public $premium;
	 ...
	 *
	 * @var Wbcr_FactoryBootstrap431_Manager
	 */
	public $bootstrap;
	 ...
	 * The Bootstrap Manager class
	 *
	 * @var Wbcr_FactoryForms428_Manager
	 */
	public $forms;

	/**
	 * Простой массив со списком зарегистрированных классов унаследованных от Wbcr_Factory430_Activator.
	 * Классы активации используются для упаковки набора функций, которые нужно выполнить во время
	 * активации плагина.
	 *
	 * @var array[] Wbcr_Factory430_Activator
	 */
	 ...
	 * @author Alexander Kovalev <alex.kovalevv@gmail.com>
	 * @since  4.1.9
	 * @var WBCR\Factory_Adverts_110\Base
	 */
	private $adverts;
	...
	public function __construct($plugin_path, $data)
	{
		...
		$this->request = new Wbcr_Factory430_Request();
		//$this->route = new Wbcr_Factory430_Route();
	 ...
	 *
	 * @param Wbcr_FactoryBootstrap431_Manager $bootstrap
	 */
	public function setBootstap(Wbcr_FactoryBootstrap431_Manager $bootstrap)
	{
	 ...
	 *
	 * @param Wbcr_FactoryForms428_Manager $forms
	 */
	public function setForms(Wbcr_FactoryForms428_Manager $forms)
	{
		$this->forms = $forms;
	}
	...
	{
		if( !isset(WBCR\Factory_430\Premium\Manager::$providers[$name]) ) {
			WBCR\Factory_430\Premium\Manager::$providers[$name] = $class_name;
		}
	}
	...
	{
		if( !isset(WBCR\Factory_430\Updates\Upgrader::$repositories[$name]) ) {
			WBCR\Factory_430\Updates\Upgrader::$repositories[$name] = $class_name;
		}
	}
	 ...
	 *
	 * @return \WBCR\Factory_Adverts_110\Base
	 * @since  1.1
	 * @author Alexander Kovalev <alex.kovalevv@gmail.com>
	 */
	...
	{
		return new Wbcr_Factory430_ScriptList($this);
	}

	public function newStyleList()
	{
		return new Wbcr_Factory430_StyleList($this);
	}
	 ...
	 * Wbcr_FactoryPages430_AdminPage, а затем регистрирует его через этот метод.
	 ...
	 *                             Регистрируемый класс должен быть унаследован от класса Wbcr_FactoryPages430_AdminPage.
	...
	public function registerPage($class_name, $file_path)
	{
		...
		if( !class_exists('Wbcr_FactoryPages430') ) {
			throw new Exception('The factory_pages_430 module is not included.');
		}

		Wbcr_FactoryPages430::register($this, $class_name);
	}
	...
	public function activation_hook()
	{
		 ...
		 */
		if( apply_filters("wbcr/factory_430/cancel_plugin_activation_{$this->plugin_name}", false) ) {
			return;
		}

		/**
		 * wbcr_factory_430_plugin_activation
		 *
		 * @since 4.1.1 - deprecated
		 */
		wbcr_factory_430_do_action_deprecated('wbcr_factory_430_plugin_activation', [
			$this
		 ...
		 */
		wbcr_factory_430_do_action_deprecated('wbcr/factory/plugin_activation', [
			$this
		 ...
		 * @since 4.1.2 - deprecated
		 */
		wbcr_factory_430_do_action_deprecated("wbcr/factory/plugin_{$this->plugin_name}_activation", [
			$this
		], '4.1.2', "wbcr/factory/before_plugin_{$this->plugin_name}_activation");

		/**
		 * wbcr_factory_430_plugin_activation_' . $this->plugin_name
		 *
		 * @since 4.1.1 - deprecated
		 */
		wbcr_factory_430_do_action_deprecated('wbcr_factory_430_plugin_activation_' . $this->plugin_name, [
			$this
	...
	public function deactivation_hook()
	{
		 ...
		 * @since 4.1.1 - change  hook name
		 */
		if( apply_filters("wbcr/factory_430/cancel_plugin_deactivation_{$this->plugin_name}", false) ) {
			return;
		}

		/**
		 * wbcr_factory_430_plugin_deactivation
		 *
		 * @since 4.1.1 - deprecated
		 */
		wbcr_factory_430_do_action_deprecated('wbcr_factory_430_plugin_deactivation', [
			$this
		 ...
		 * @since 4.1.2 - deprecated
		 */
		wbcr_factory_430_do_action_deprecated('wbcr/factory/plugin_deactivation', [
			$this
		...
		/**
		 * wbcr_factory_430_plugin_deactivation_ . $this->plugin_name
		 *
		 * @since 4.1.1 - deprecated
		 */
		wbcr_factory_430_do_action_deprecated('wbcr_factory_430_plugin_deactivation_' . $this->plugin_name, [
			$this
		 ...
		 * @since 4.1.2 - deprecated
		 */
		wbcr_factory_430_do_action_deprecated("wbcr/factory/plugin_{$this->plugin_name}_deactivation", [
			$this
	...
	public function getPluginPageUrl($page_id, $args = [])
	{
		...
		return Wbcr_FactoryPages430::getPageUrl($this, $page_id, $args);
	}
	...
	private function init_framework_modules()
	{
		 ...
		 * @since 4.1.1 - deprecated
		 */
		wbcr_factory_430_do_action_deprecated('wbcr_factory_430_core_modules_loaded-' . $this->plugin_name, [], '4.1.1', "wbcr/factory_430/modules_loaded-" . $this->plugin_name);

		/**
		 * @since 4.1.1 - add
		 */
		do_action('wbcr/factory_430/modules_loaded-' . $this->plugin_name);
	}
	...
	private function register_plugin_hooks()
	{
		...
		if( is_admin() ) {
			add_filter('wbcr_factory_430_core_admin_allow_multisite', '__return_true');
	...
	{
		new WBCR\Factory_430\Migrations($this);
	}
	...
	{
		new Wbcr\Factory_430\Notices($this);
	}
	...
	{
		if( $this->has_updates ) {
			new WBCR\Factory_430\Updates\Upgrader($this);
		}
	}
	...
	protected function init_plugin_premium_features()
	{
		...
		$this->premium = WBCR\Factory_430\Premium\Manager::instance($this, $this->license_settings);

		// Подключаем премиум апгрейдер
		if( isset($this->license_settings['has_updates']) && $this->license_settings['has_updates'] ) {
			new WBCR\Factory_430\Updates\Premium_Upgrader($this);
		}
	}
}
