...
namespace WBCR\Factory_430\Updates;

use Exception;
use Plugin_Installer_Skin;
use Plugin_Upgrader;
use Wbcr_Factory430_Plugin;
use Wbcr_FactoryPages430_ImpressiveThemplate;
...
class Premium_Upgrader extends Upgrader {
	 ...
	 *
	 * @param Wbcr_FactoryPages430_ImpressiveThemplate $obj
	 *
	 * @param Wbcr_Factory430_Plugin $plugin
	 *
	 * @return void
	...
	private function get_notice_text($type)
	{
		...
		$texts = [
			'need_activate_license' => __('License activation required. A license is required to get premium plugin updates, as well as to get additional services.', 'wbcr_factory_430'),
			'need_renew_license' => __('Your license has expired. You can no longer get premium plugin updates, premium support and your access to Webcraftic services has been suspended.', 'wbcr_factory_430'),
        ...
        <a href="%s">Install</a> premium add-on or <a href="%s">cancel</a> license.', 'wbcr_factory_430'), $upgrade_url, $cancel_license_url),
        ...
        <a href="%s">Activate</a> premium add-on or <a href="%s">cancel</a> license.', 'wbcr_factory_430'), $activate_plugin_url, $cancel_license_url)
		];
