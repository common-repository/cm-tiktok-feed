...
class Upgrader {
	 ...
	 * [
	 *  'wordpress' => 'WBCR\Factory_Freemius_118\Updates\Freemius_Repository',
	 *  'freemius' => '\WBCR\Factory_430\Updates\Wordpress_Repository'
	 * ]
	 */
	...
	public function __construct( Wbcr_Factory430_Plugin $plugin ) {
		...
		self::$repositories['wordpress'] = '\WBCR\Factory_430\Updates\Wordpress_Repository';
	...
	protected function get_repository( $repository_name ) {
		...
		if ( isset( self::$repositories[ $repository_name ] ) && class_exists( self::$repositories[ $repository_name ] ) ) {
			if ( self::$repositories[ $repository_name ] instanceof Repository ) {
				throw new Exception( "Repository {$repository_name} must extend the class WBCR\Factory_430\Updates\Repository interface!" );
			}
