...
/**
 * Базовый класс для создания нового плагина. Полную реализацию класса смотрите в Wbcr_Factory430_Plugin
 *
 ...
 */
class  Wbcr_Factory430_Base {

	use WBCR\Factory_430\Options;
	 ...
	 * экземпляр класса \WBCR\Factory_430\Entities\Support, для получения информации о сайте плагина.
	 ...
	 * WBCR\Factory_430\Premium\Provider > WBCR\Factory_Freemius_118\Premium\Provider
	 *
	...
	protected $load_factory_modules = [
		[ 'libs/factory/bootstrap', 'factory_bootstrap_431', 'admin' ],
		[ 'libs/factory/forms', 'factory_forms_428', 'admin' ],
		[ 'libs/factory/pages', 'factory_pages_430', 'admin' ],
	];
	...
	/**
	 * Экземпляр класса \WBCR\Factory_430\Entities\Support используется для получения информации
	 ...
	 *
	 * @var \WBCR\Factory_430\Entities\Support
	 */
	protected $support;

	/**
	 * Экземпляр класса \WBCR\Factory_430\Entities\Paths используется для получения информации о
	 * путях плагина. Часто используется для получения путей или ссылок на место хранения плагина
	 * или его входного файла.
	 *
	 * @var \WBCR\Factory_430\Entities\Paths
	 */
	protected $paths;
	...
	public function __construct( $plugin_file, $data ) {
		...
		$this->support = new \WBCR\Factory_430\Entities\Support( $this->support_details );
		$this->paths   = new \WBCR\Factory_430\Entities\Paths( $plugin_file );
	 ...
	 * См. Wbcr_Factory430_Base::has_premium
	 */
	 ...
	 *
	 * @return string Возвращает заголовок плагина. См. Wbcr_Factory430_Base::plugin_title
	 */
	 ...
	 *
	 * @return string Возвращает префикс плагина.См. Wbcr_Factory430_Base::prefix
	 */
	 ...
	 *
	 * @return string Возвращает имя плагина. См. Wbcr_Factory430_Base::plugin_name
	 */
	 ...
	 *
	 * @return string Возвращает версию плагина. См. Wbcr_Factory430_Base::plugin_version
	 */
	 ...
	 *                            Wbcr_Factory430_Base::plugin_data
	 *
	 * @return null
	 */
	...
	/**
	 * Предоставляет доступ к экземпляру класса \WBCR\Factory_430\Entities\Support.
	 *
	 * @return \WBCR\Factory_430\Entities\Support
	 */
	...
	/**
	 * Предоставляет доступ к экземпляру класса \WBCR\Factory_430\Entities\Paths.
	 *
	 * @return \WBCR\Factory_430\Entities\Paths
	 */
	 ...
	 *
	 * @return object Возвращает объект с сырыми данными плагина. См. Wbcr_Factory430_Base::plugin_data
	 */
