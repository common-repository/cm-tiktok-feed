...
namespace WBCR\Factory_430\Premium;
...
class Manager {
	 ...
	 * @param array                  $settings
	 *
	 * @return \WBCR\Factory_Freemius_118\Premium\Provider
	 * @throws Exception
	 */
	public static function instance( Wbcr_Factory430_Plugin $plugin, array $settings ) {
	...
	public function instance_provider() {
		...
		if ( isset( self::$providers[ $provider_name ] ) && class_exists( self::$providers[ $provider_name ] ) ) {
			if ( self::$providers[ $provider_name ] instanceof Provider ) {
				throw new Exception( "Provider {$provider_name} must extend the class WBCR\Factory_430\Premium\Provider interface!" );
			}
