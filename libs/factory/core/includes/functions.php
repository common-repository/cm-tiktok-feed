 ...
 *
 * @return mixed
 * @see   wbcr_factory_430_deprecated_hook()
 *
 */
function wbcr_factory_430_apply_filters_deprecated( $tag, $args, $version, $replacement = false, $message = null ) {
	...
	wbcr_factory_430_deprecated_hook( $tag, $version, $replacement, $message );
 ...
 *
 */
function wbcr_factory_430_do_action_deprecated( $tag, $args, $version, $replacement = false, $message = null ) {
 ...
 *
 * Use the 'wbcr_factory_430_deprecated_hook_run' action to get the backtrace describing where the
 ...
 * @param string $message       Optional. A message regarding the change.
 */
function wbcr_factory_430_deprecated_hook( $hook, $version, $replacement = null, $message = null ) {
	/**
