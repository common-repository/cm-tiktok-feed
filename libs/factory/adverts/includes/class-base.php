...
namespace WBCR\Factory_Adverts_110;
...
class Base {
	 ...
	 * @author Alexander Kovalev <alex.kovalevv@gmail.com>
	 * @since  1.0.1
	 * @var \WBCR\Factory_Adverts_110\Creative_Motion_API
	 */
	private $api;
	 ...
	 */
	public function __construct( \Wbcr_Factory430_Plugin $plugin, $settings ) {
		$this->plugin = $plugin;
	...
	public function register_dashboard_widget() {
		if ( $this->settings['dashboard_widget'] && current_user_can( 'manage_options' ) ) {
			...
			require_once FACTORY_ADVERTS_110_DIR . '/includes/class-dashboard-widget.php';
