 ...
 * @since 2.0.7
 */
class WTIK_LicensePage extends WTIK_Page {
	...
	/**
	 * @since 2.0.7
	 * @var \WBCR\Factory_430\Premium\Interfaces\License
	 */
	...
	public function __construct( $plugin ) {
		...
		$this->id            = 'license';
		$this->menu_title    = '<span style="color:#f18500">' . __( 'License', 'tiktok-feed' ) . '</span>';
		$this->page_title    = __( 'License of TikTok Feed Widget', 'tiktok-feed' );
		$this->template_name = "license";
		$this->menu_target   = "widgets-" . $plugin->getPluginName();
		$this->capabilitiy   = "manage_options";

		$this->premium                  = WTIK_Plugin::app()->premium;
	...
	public function assets( $scripts, $styles ) {
		...
		$this->styles->add( WTIK_PLUGIN_URL . '/admin/assets/css/license-manager.css' );
		...
		$this->scripts->add( WTIK_PLUGIN_URL . '/admin/assets/js/license-manager.js' );
	}
